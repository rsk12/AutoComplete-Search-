...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] from = new String[]{"doctorName"};
        ...
        if (searchView != null) {
            ...
            searchView.setOnSuggestionListener(new SearchView.OnSuggestionListener() {
                ...
                public boolean onSuggestionClick(int position) {
                    ...
                    searchView.setQuery(cursor.getString(cursor.getColumnIndex("doctorName")), false);
                    return true;
                }
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String s) {
                    ...
                    // Filter data
                    final MatrixCursor mc = new MatrixCursor(new String[]{BaseColumns._ID, "doctorName"});
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://192.168.1.27/PHP/fetch-all-doctor.php");
            ...
            if (result.equals("no rows")) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        dataList.add(json_data.getString("doctor_name"));
                    }
